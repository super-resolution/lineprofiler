...
"}")
        ...
        self.spinBox_upper_limit.setMaximum(1500)
        ...
        self.spinBox_intensity_threshold = QtWidgets.QSpinBox(self.groupBox_config_calibration)
        self.spinBox_intensity_threshold.setMinimum(1)
        self.spinBox_intensity_threshold.setMaximum(60)
        self.spinBox_intensity_threshold.setProperty("value", 30)
        self.spinBox_intensity_threshold.setObjectName("spinBox_intensity_threshold")
        self.horizontalLayout_2.addWidget(self.spinBox_intensity_threshold)
        self.horizontalSlider_intensity_threshold = QtWidgets.QSlider(self.groupBox_config_calibration)
        self.horizontalSlider_intensity_threshold.setMinimum(1)
        self.horizontalSlider_intensity_threshold.setMaximum(60)
        self.horizontalSlider_intensity_threshold.setProperty("value", 30)
...
"")
        ...
        self.spinBox_intensity_threshold.valueChanged['int'].connect(self.horizontalSlider_intensity_threshold.setValue)
        self.horizontalSlider_intensity_threshold.valueChanged['int'].connect(self.spinBox_intensity_threshold.setValue)
