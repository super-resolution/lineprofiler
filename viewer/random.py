...
"}")
        ...
        self.horizontalSlider_intensity_threshold = QtWidgets.QSlider(self.tab_4)
        ...
        self.verticalLayout_4.addWidget(self.horizontalSlider_intensity_threshold)
